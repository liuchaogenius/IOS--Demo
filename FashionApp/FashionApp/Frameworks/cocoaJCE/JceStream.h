...
do {                                                                            \
    if (!(x)) {                                                                 \
        NSException *exception = [NSException exceptionWithName:@"WupSerializableException" reason:[NSString stringWithFormat:@"%s, %zd: assert(%@) fail!", __func__, (__LINE__), @#x] userInfo:nil];  \
        @throw exception;                                                       \
    }                                                                           \
} while(0)
